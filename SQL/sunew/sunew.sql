...
-- Schema compras
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sunew_2018` DEFAULT CHARACTER SET latin1 ;
USE `sunew_2018` ;

-- -----------------------------------------------------
-- Table `sunew_2018`.`Destinacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Destinacao` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Moedas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Moedas` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Projetos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Projetos` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`TipoReq`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`TipoReq` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`StatusRequisicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`StatusRequisicao` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`TipoFrete`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`TipoFrete` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Niveis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Niveis` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Usuario` (
  ...
  CONSTRAINT `fk_Usuario_Niveis1`
    ...
    REFERENCES `sunew_2018`.`Niveis` (`CodNivel`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`StatusArq`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`StatusArq` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Solicitante`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Solicitante` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`EtapaRequisicao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`EtapaRequisicao` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Requisicoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Requisicoes` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Item` (
  ...
  CONSTRAINT `fk_Item_Requisicoes1`
    ...
    REFERENCES `sunew_2018`.`Requisicoes` (`CodRequisicao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Fornecedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Fornecedores` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`TipoCobranca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`TipoCobranca` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`OrdemPagto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`OrdemPagto` (
  ...
  CONSTRAINT `fk_OrdemPagto_TipoCobranca1`
    ...
    REFERENCES `sunew_2018`.`TipoCobranca` (`CodTipoCobranca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`TipoEmbarque`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`TipoEmbarque` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`ReqInterOutros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`ReqInterOutros` (
  ...
  CONSTRAINT `fk_ReqInterOutros_TipoEmbarque1`
    ...
    REFERENCES `sunew_2018`.`TipoEmbarque` (`CodTipoEmbarque`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`ReqPO`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`ReqPO` (
  `CodRequisicao` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`Solicitacoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`Solicitacoes` (
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`ItemSolicitacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`ItemSolicitacao` (
  ...
  CONSTRAINT `fk_ItemSolicitacao_Solicitacoes1`
    ...
    REFERENCES `sunew_2018`.`Solicitacoes` (`CodSolicitacao`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `sunew_2018`.`FornecedoresSolicitacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sunew_2018`.`FornecedoresSolicitacao` (
  `CodFornecedor` INT(11) NOT NULL AUTO_INCREMENT,
  `NomeFornecedor` VARCHAR(255) NULL DEFAULT NULL,
  `Telefone` VARCHAR(255) NULL DEFAULT NULL,
  `Email` VARCHAR(255) NULL DEFAULT NULL,
