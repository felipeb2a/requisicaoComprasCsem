 ...
 */
public class TelaRequisicaoAprovacao extends javax.swing.JFrame {
    ...
    public TelaRequisicaoAprovacao() {
        initComponents();
        AlteraFontTable();
        bloquearCampos();
        MaximizeTela();
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaRequisicaoAprovacao.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaRequisicaoAprovacao.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaRequisicaoAprovacao.class.getName()).log(Level.SEVERE, null, ex1);
        }
...
//            }
    ...
    private void initComponents() {
        ...
        btAprova1 = new javax.swing.JMenuItem();
        ...
        lbTitulo.setText("REQUISIÇÃO DE COMPRA (APROVAÇÃO) ");
        ...
        btAprova1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.ALT_MASK));
        btAprova1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btAprova1.setText("Aprovar");
        btAprova1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btAprova1ActionPerformed(evt);
            }
        });
        MenuRequisicao.add(btAprova1);

        btRecusar1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.ALT_MASK));
        btRecusar1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btRecusar1.setText("Recusar");
        btRecusar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btRecusar1ActionPerformed(evt);
            }
        });
        MenuRequisicao.add(btRecusar1);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(cbTipoAprovador, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(62, 62, 62)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addComponent(txtCodReqTitulo, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btAprova1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAprova1ActionPerformed
        try {
            RequisicoesDAO requisicaoDao = new RequisicoesDAO();
            Requisicoes requisicao = new Requisicoes();
            requisicao.setId(Integer.parseInt(txtCodRequisicao.getText()));
            ...
            if (nivel.equals("Aprovador Financeiro")) {
                ...
                requisicao.setAprovadorTecnico(lbLogin.getText());
                requisicaoDao.aprovarTecnicoRequisicao(requisicao, nameDb);
            }
...
//            }
    ...
    }//GEN-LAST:event_btAprova1ActionPerformed
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRequisicaoAprovacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRequisicaoAprovacao().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem btAprova1;
