 ...
 */
public class TelaSelecioneLista extends javax.swing.JFrame {
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaSelecioneLista.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaSelecioneLista.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaSelecioneLista.class.getName()).log(Level.SEVERE, null, ex1);
        }
    ...
    public void ObterLogin(Usuario login) {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Você ainda não possui login cadastre-se!");
        }
    }

    //ACTION BUTTON LISTA SOLICITACOES
    public void EntrarSolicitacoes() {
        try {
            //TELA SOLICITACOES
...
//            }
    ...
    //ACTION BUTTON LISTA REQUISICOES
    public void EntrarRequisicoes() {
        try {
            //TELA REQUISICAO
...
//            }
    ...
    private void initComponents() {
        ...
        jButton1.setText("LISTA REQUISIÇÕES");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaSelecioneLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaSelecioneLista().setVisible(true);
            }
        });
    }
