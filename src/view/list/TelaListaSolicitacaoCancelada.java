...
public class TelaListaSolicitacaoCancelada extends javax.swing.JFrame {
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaSolicitacaoCancelada.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaSolicitacaoCancelada.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaSolicitacaoCancelada.class.getName()).log(Level.SEVERE, null, ex1);
        }
...
//                }
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("SOLICITAÇÕES CANCELADAS");
