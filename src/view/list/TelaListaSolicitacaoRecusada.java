 ...
 */
public class TelaListaSolicitacaoRecusada extends javax.swing.JFrame {
    ...
    public void Relatorio() {
        try {
            ...
            List listaRequisicao = solicitacaoDAO.listaSolicitacoesRecusada(usuario, nameDb);
    ...
    private void initComponents() {
        ...
        jMenuSolicitacaoRecusada = new javax.swing.JMenu();
        ...
        lbTitulo.setText("SOLICITAÇÕES RECUSADAS");
        ...
        jMenuSolicitacaoRecusada.setText("Recusadas");
        jMenuSolicitacaoRecusada.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jMenuSolicitacaoRecusada.add(btVisualizar);

        menu.add(jMenuSolicitacaoRecusada);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaSolicitacaoRecusada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaSolicitacaoRecusada().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenu jMenuSolicitacaoRecusada;
