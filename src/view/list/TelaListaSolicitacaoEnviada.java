 ...
 */
public class TelaListaSolicitacaoEnviada extends javax.swing.JFrame {
    ...
    public TelaListaSolicitacaoEnviada() {
        initComponents();
        AlteraFontTable();
        MaximizeTela();
    }
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaSolicitacaoEnviada.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaSolicitacaoEnviada.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaSolicitacaoEnviada.class.getName()).log(Level.SEVERE, null, ex1);
        }
    ...
    public void Relatorio() {
        try {
            ...
            List listaRequisicao = solicitacaoDAO.listaSolicitacoesEnviada(usuario, nameDb);
...
//                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaSolicitacaoEnviada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaSolicitacaoEnviada().setVisible(true);
            }
        });
    }
