...
import view.TelaSolicitacaoNova;
 ...
 */
public class TelaListaSolicitacoes extends javax.swing.JFrame {
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaSolicitacoes.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaSolicitacoes.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaSolicitacoes.class.getName()).log(Level.SEVERE, null, ex1);
        }
    ...
    public void Relatorio() {
        try {
            ...
            String Nomeusuario = lbLogin.getText();
            ...
            List listaSolicitacao = solicitacaoDAO.localizarSolicitacoesPorUser(solicitacao, nameDb);
...
//            }
    ...
    public void Filtro() {
        try {
            ...
            List listaRequisicao = solicitacaoDAO.FiltrarSolicitacoesUser(usuario, nameDb);
            DefaultTableModel model = (DefaultTableModel) tbSolicitacao.getModel();
            model.setNumRows(0);
...
//            }
    ...
    public void ListarCombobox() throws SQLException, ClassNotFoundException {
        try {
            ...
            Iterator it;
            //STATUS REQUISICAO
            /*it = listStatusRequisicao.iterator();
...
//            }
    ...
    public void Criar() {
        if (tbSolicitacao.getSelectedRow() < 0) {
            ...
            TelaSolicitacaoNova tela = new TelaSolicitacaoNova();
...
//                }
    ...
    private void initComponents() {
        ...
        jMenuSolicitacoesArquivadas = new javax.swing.JMenuItem();
        jMenuSolicitacoesCanceladas = new javax.swing.JMenuItem();
        jMenuSolicitacoesCanceladas1 = new javax.swing.JMenuItem();
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(lbNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jMenuSolicitacoes.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jMenuSolicitacoes.add(jMenuItem6);
        ...
        jMenuItem4.setText("Enviadas");
        jMenuItem4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem4ActionPerformed(evt);
            }
        });
        jMenuSolicitacoes.add(jMenuItem4);

        jMenuSolicitacoesArquivadas.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_A, java.awt.event.InputEvent.ALT_MASK));
        jMenuSolicitacoesArquivadas.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jMenuSolicitacoesArquivadas.setText("Arquivadas");
        jMenuSolicitacoesArquivadas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuSolicitacoesArquivadasActionPerformed(evt);
            }
        });
        jMenuSolicitacoes.add(jMenuSolicitacoesArquivadas);

        jMenuSolicitacoesCanceladas.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_Z, java.awt.event.InputEvent.ALT_MASK));
        jMenuSolicitacoesCanceladas.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jMenuSolicitacoesCanceladas.setText("Canceladas");
        jMenuSolicitacoesCanceladas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuSolicitacoesCanceladasActionPerformed(evt);
            }
        });
        jMenuSolicitacoes.add(jMenuSolicitacoesCanceladas);

        jMenuSolicitacoesCanceladas1.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_R, java.awt.event.InputEvent.ALT_MASK));
        jMenuSolicitacoesCanceladas1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jMenuSolicitacoesCanceladas1.setText("Recusadas");
        jMenuSolicitacoesCanceladas1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuSolicitacoesCanceladas1ActionPerformed(evt);
            }
        });
        jMenuSolicitacoes.add(jMenuSolicitacoesCanceladas1);

        menu.add(jMenuSolicitacoes);

        jMenu5.setText("Voltar");
        jMenu5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jMenuItemVoltar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_V, java.awt.event.InputEvent.ALT_MASK));
        jMenuItemVoltar.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        try {
            //TELA BUSCA ITEM
            TelaListaSolicitacaoEnviada tela = new TelaListaSolicitacaoEnviada();
            this.setVisible(false);
            tela.ObterLogin(obterLogin);
            tela.nameDb(nameDb);
            tela.mostrarTela(mostrarTela);
...
//            }
    ...
    private void jMenuSolicitacoesArquivadasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuSolicitacoesArquivadasActionPerformed
        try {
            //TELA LISTA ARQV
            TelaListaSolicitacaoArquivada tela = new TelaListaSolicitacaoArquivada();
            this.setVisible(false);
            tela.ObterLogin(obterLogin);
            tela.nameDb(nameDb);
            tela.mostrarTela(mostrarTela);
...
//            }
    ...
    }//GEN-LAST:event_jMenuSolicitacoesArquivadasActionPerformed

    private void jMenuSolicitacoesCanceladasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuSolicitacoesCanceladasActionPerformed
        try {
            //TELA BUSCA ITEM
            TelaListaSolicitacaoCancelada tela = new TelaListaSolicitacaoCancelada();
            this.setVisible(false);
            tela.ObterLogin(obterLogin);
            tela.nameDb(nameDb);
            tela.mostrarTela(mostrarTela);
...
//            }
    ...
    }//GEN-LAST:event_jMenuSolicitacoesCanceladasActionPerformed
    ...
    private void jMenuSolicitacoesCanceladas1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuSolicitacoesCanceladas1ActionPerformed
        try {
            //TELA RECUSADA
            TelaListaSolicitacaoRecusada tela = new TelaListaSolicitacaoRecusada();
            this.setVisible(false);
            tela.ObterLogin(obterLogin);
            tela.nameDb(nameDb);
            tela.mostrarTela(mostrarTela);
...
//            }
    ...
    }//GEN-LAST:event_jMenuSolicitacoesCanceladas1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaSolicitacoes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaSolicitacoes().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenuItem jMenuSolicitacoesArquivadas;
    private javax.swing.JMenuItem jMenuSolicitacoesCanceladas;
    private javax.swing.JMenuItem jMenuSolicitacoesCanceladas1;
