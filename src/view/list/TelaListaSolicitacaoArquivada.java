 ...
 */
public class TelaListaSolicitacaoArquivada extends javax.swing.JFrame {
    ...
    public TelaListaSolicitacaoArquivada() {
        initComponents();
        AlteraFontTable();
        MaximizeTela();
    }
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaSolicitacaoArquivada.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaSolicitacaoArquivada.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaSolicitacaoArquivada.class.getName()).log(Level.SEVERE, null, ex1);
        }
    ...
    public void Relatorio() {
        try {
            ...
            List listaRequisicao = solicitacaoDAO.listaSolicitacoesArquivadas(usuario, nameDb);
...
//                }
    ...
    private void btVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVoltarActionPerformed
        try {
            ...
            Logger.getLogger(TelaListaSolicitacaoArquivada.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(TelaListaSolicitacaoArquivada.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaSolicitacaoArquivada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaSolicitacaoArquivada().setVisible(true);
            }
        });
    }
