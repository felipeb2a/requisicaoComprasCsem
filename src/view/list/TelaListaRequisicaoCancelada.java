 ...
 */
public class TelaListaRequisicaoCancelada extends javax.swing.JFrame {
    ...
    public TelaListaRequisicaoCancelada() {
        initComponents();
        AlteraFontTable();
        MaximizeTela();
    }
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaRequisicaoCancelada.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaRequisicaoCancelada.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaRequisicaoCancelada.class.getName()).log(Level.SEVERE, null, ex1);
        }
    ...
    public void Relatorio() {
        try {
            ...
            List listaRequisicao = requisicaoDAO.localizarRequisicoesCanceladaUser(usuario, nameDb);
...
//                }
    ...
    private void initComponents() {
        ...
        jMenuRequisicaoCancelada = new javax.swing.JMenu();
        ...
        lbTitulo.setText("REQUISIÇÃO CANCELADAS");
        ...
        jMenuRequisicaoCancelada.setText("Canceladas");
        jMenuRequisicaoCancelada.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jMenuRequisicaoCancelada.add(btVisualizar);

        menu.add(jMenuRequisicaoCancelada);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaListaRequisicaoCancelada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaRequisicaoCancelada().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JMenu jMenuRequisicaoCancelada;
