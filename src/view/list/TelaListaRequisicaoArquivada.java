...
public class TelaListaRequisicaoArquivada extends javax.swing.JFrame {
    ...
    public Logger Definirlogger() {
        Log log = new Log();
        try {
            logger = log.pathLog(TelaListaRequisicaoArquivada.class.getName(), nameDb);
        } catch (SecurityException ex1) {
            Logger.getLogger(TelaListaRequisicaoArquivada.class.getName()).log(Level.SEVERE, null, ex1);
        } catch (Exception ex1) {
            Logger.getLogger(TelaListaRequisicaoArquivada.class.getName()).log(Level.SEVERE, null, ex1);
        }
